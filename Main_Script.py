...
marble_pos_path, marble_rot_path = marble_path(5*612, 0.0025, mu.Vector((-0.09409496188163757, 0.1060512512922287, 0.10304122418165207)), mu.Vector((0.38,-0.123,0)), ob_Sphere_location, ob_Marble_rotation)
